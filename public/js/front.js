...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Post__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Post */ "./resources/js/pages/Post.vue");
//
//
//
//
  ...
  mounted: function mounted() {
    ...
    axios.get("/api/posts/" + slug).then(function (response) {
      if (response.data.success == false) {
        _this.$router.push({
          name: "not-found"
        }); //con questa sintassi, faccio il redirect alla rotta 404

      } else {
        _this.post = response.data.result; //memorizzo le informazioni del singolo post nella variabile this.post
      }
    });
  }
});
...
var staticRenderFns = [
  function () {
    ...
    var _c = _vm._self._c || _h
    return _c("div", [
      _c("h1", [_vm._v("Descrizione accurata di noi")]),
      _vm._v(" "),
      _c("p", [
        _vm._v(
          "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error quae numquam consequuntur reiciendis sed dolor quis mollitia minima aliquid ab nisi pariatur, fuga quos illo asperiores doloremque nemo. Dolor, repellat!"
        ),
      ]),
      _vm._v(" "),
...
var render = function () {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("h1", [_vm._v("Benvenuto, questa è la home del sito")])
}
var staticRenderFns = []
render._withStripped = true
...
var staticRenderFns = [
  function () {
    ...
    var _c = _vm._self._c || _h
    return _c("div", [
      _c("h1", [_vm._v("Errore 404")]),
      _vm._v(" "),
      _c("h2", [_vm._v("Pagina non trovata")]),
    ])
  },
]
render._withStripped = true
...
window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); //importiamo axios per le chiamate API che faremo nel frontend
...
/* harmony import */ var _pages_Posts_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/Posts.vue */ "./resources/js/pages/Posts.vue");
/* harmony import */ var _pages_SinglePost_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/SinglePost.vue */ "./resources/js/pages/SinglePost.vue");
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); //La cartella "pages" dentro resources, conterrà tutte le view di frontend che saranno gestite da VueRouter (rigo 13)
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/blog/:slug',
    //equivale a Laravel: Route::get('/blog/{slug}', 'Api\PostController@show');
    name: 'single-post',
...
module.exports = __webpack_require__(/*! C:\Users\simone\OneDrive\Documenti\BOOLEAN CAREERS\ESERCIZI\LARAVEL\laravel-boolpress\resources\js\front.js */"./resources/js/front.js");
